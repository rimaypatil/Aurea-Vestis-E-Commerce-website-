...
export default function SneakerSalePage() {
    ...
    const fetchProducts = useCallback(async () => {
        ...
        try {
            const params = {
                category: 'Sneakers',
                minPrice: 1999, // Base condition for this page
                sort: sortBy
            };
            ...
            if (selectedFilters.priceRanges && selectedFilters.priceRanges.length > 0) {
                ...
                // Respect the hard floor of 1999 but allow user to filter higher
                params.minPrice = Math.max(1999, Math.min(...mins));
            ...
            console.error("Failed to fetch sneaker sale items", err);
            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col gap-4 mb-8">
                    ...
                    <div className="flex justify-between items-end">
                        <div>
                            <h1 className="text-3xl md:text-4xl font-heading font-black text-brand-accent uppercase tracking-tight">Sneakers Starting ₹1999</h1>
                            <p className="text-gray-500 text-sm mt-2">Premium kicks at unbeatable entry prices.</p>
                        </div>
                    </div>
                </div>
